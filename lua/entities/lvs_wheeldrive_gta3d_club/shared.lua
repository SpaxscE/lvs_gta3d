...
ENT.MDL = "models/diggercars/gtasa/club/club.mdl"

ENT.GibModels = {
	"models/diggercars/gtasa/club/bonnet_dam.mdl",
	"models/diggercars/gtasa/club/boot_dam.mdl",
	"models/diggercars/gtasa/club/bump_front_dam.mdl",
	"models/diggercars/gtasa/club/bump_rear_dam.mdl",
	"models/diggercars/gtasa/club/door_lf_dam.mdl",
	"models/diggercars/gtasa/club/door_rf_dam.mdl",
}
...
ENT.Lights = {
	...
	},	
	{
		...
		SubMaterialID = 17,
		Sprites = {
			{  pos = "a_flh", width = 125, colorB = 200, colorA = 150, bodygroup = { name = "l_flt", active = { 0 } }, },
			{  pos = "a_frh", width = 125, colorB = 200, colorA = 150, bodygroup = { name = "l_frt", active = { 0 } }, },
		},
		ProjectedTextures = {
			{  pos = "a_flh", colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "l_flt", active = { 0 } }, },
			{  pos = "a_frh", colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "l_frt", active = { 0 } }, },
		},
	},	
}
