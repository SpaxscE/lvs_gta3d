...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( self:WorldToLocal( att_seat1.Pos ) + Vector(-20,0,-13), self:WorldToLocalAngles( att_seat1.Ang) + Angle(0,-90,-90) )
	local RFSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat2.Pos ) + Vector(-10,0,-6), self:WorldToLocalAngles( att_seat2.Ang ) + Angle(0,-90,-75) )
