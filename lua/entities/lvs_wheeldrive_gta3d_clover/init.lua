...
function ENT:OnSpawn( PObj )
	...
	local RFSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat2.Pos ) + Vector(3,0,-5), self:WorldToLocalAngles( att_seat2.Ang ) + Angle(0,-90,-75) )
	...
	local WheelModel = "models/diggercars/gtasa/shared/wheel_clover.mdl"
