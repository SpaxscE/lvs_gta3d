function ENT:CreatePDS()
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [1] = 2 }, sound = "SA_Collision", maxvelocity = 500 },
			{
				...
				bodygroup = { [1] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/bonnet_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [2] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [2] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/boot_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [3] = 1 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [3] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/bump_front_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [4] = 1 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [4] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/bump_rear_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [6] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [6] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/door_lf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [5] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [5] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/door_rf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	-- blinker taillight left
	local pos, ang, mins, maxs = self:GetBoneInfo( "l_rlt" )
	self:AddPDS( {
		pos = pos,
		ang = ang,
		mins = mins,
	...
	-- blinker taillight right
	local pos, ang, mins, maxs = self:GetBoneInfo( "l_rrt" )
	self:AddPDS( {
		pos = pos,
		ang = ang,
		mins = mins,
	...
	self:AddPDS( {
		...
		maxs = maxs,
		stages = {
			{ bodygroup = { [17] = 1 }, sound = "SA_Collision" },
			{ bodygroup = { [17] = 1 }, sound = "SA_Collision" },
			{
				sound = "SA_Collision",
				bodygroup = { [17] = 2 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/wing_lf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		maxs = maxs,
		stages = {
			{ bodygroup = { [16] = 1 }, sound = "SA_Collision" },
			{ bodygroup = { [16] = 1 }, sound = "SA_Collision" },
			{
				sound = "SA_Collision",
				bodygroup = { [16] = 2 },
				gib = {
					mdl = "models/diggercars/gtasa/vc/stinger/wing_rf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
