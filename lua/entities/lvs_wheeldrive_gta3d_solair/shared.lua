...
ENT.MDL = "models/diggercars/gtasa/solair/solair.mdl"

ENT.GibModels = {
	"models/diggercars/gtasa/solair/bonnet_dam.mdl",
	"models/diggercars/gtasa/solair/boot_dam.mdl",
	"models/diggercars/gtasa/solair/bump_front_dam.mdl",
	"models/diggercars/gtasa/solair/bump_rear_dam.mdl",
	"models/diggercars/gtasa/solair/door_lf_dam.mdl",
	"models/diggercars/gtasa/solair/door_rf_dam.mdl",
}
...
ENT.Lights = {
	{
		...
		Sprites = {
			...
			{  pos = "a_fl2", width = 125, colorB = 200, colorA = 150, bodygroup = { name = "l_fl", active = { 0 } }, },
			{  pos = "a_fr2", width = 125, colorB = 200, colorA = 150, bodygroup = { name = "l_fr", active = { 0 } }, },
		},
	},

	{
		...
		ProjectedTextures = {
			...
			{  pos = "a_fl2", colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "l_fl", active = { 0 } }, },
			{  pos = "a_fr2", colorB = 200, colorA = 150, shadows = true, bodygroup = { name = "l_fr", active = { 0 } }, },
		},
	},
