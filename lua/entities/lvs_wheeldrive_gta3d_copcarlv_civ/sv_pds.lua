	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [1] = 2 }, sound = "SA_Collision", maxvelocity = 500 },
			{
				...
				bodygroup = { [1] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/bonnet_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [2] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [2] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/boot_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [3] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [3] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/bump_front_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [4] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [4] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/bump_rear_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [6] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [6] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/door_lf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [5] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [5] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/door_rf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [8] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [8] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/door_lr_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [7] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [7] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/copcarlv/door_rr_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
