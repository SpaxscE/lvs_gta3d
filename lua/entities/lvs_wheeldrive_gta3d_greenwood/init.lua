...
function ENT:OnSpawn( PObj )
	...
	local RRSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat3.Pos ) + Vector(-2,0,-6), self:WorldToLocalAngles( att_seat3.Ang ) + Angle(0,-90,-90) )
	local LRSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat4.Pos ) + Vector(-2,0,-6), self:WorldToLocalAngles( att_seat4.Ang ) + Angle(0,-90,-90) )
