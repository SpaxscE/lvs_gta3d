...
function ENT:OnSpawn( PObj )
	...
	local RFSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat2.Pos ) + Vector(-1,0,-6), self:WorldToLocalAngles( att_seat2.Ang ) + Angle(0,-90,-77) )
	local RRSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat3.Pos ) + Vector(-4,0,-6), self:WorldToLocalAngles( att_seat3.Ang ) + Angle(0,-90,-77) )
	local LRSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat4.Pos ) + Vector(-4,0,-6), self:WorldToLocalAngles( att_seat4.Ang ) + Angle(0,-90,-77) )
	...
	local WheelModel = "models/diggercars/gtasa/shared/wheel_greenwood.mdl"
