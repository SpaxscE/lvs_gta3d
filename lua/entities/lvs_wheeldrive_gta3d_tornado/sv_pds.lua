function ENT:CreatePDS()
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [1] = 2 }, sound = "SA_Collision", maxvelocity = 500 },
			{
				sound = "SA_Collision",
				bodygroup = { [1] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/tornado/bonnet_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [2] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [2] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/tornado/boot_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
		...
		stages = {
			...
			},
			{
				...
				Callback = function( tbl, ent, pds, speed )
					...
					if bgroup == 2 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_front_dam.mdl"
					end

					if bgroup == 5 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_front1_dam.mdl"
					end

					if bgroup == 8 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_front2_dam.mdl"
					end
				end,
				sound = "SA_Collision",
				gib = {
		...
		stages = {
			...
			},
			{
				...
				Callback = function( tbl, ent, pds, speed )
					...
					if bgroup == 2 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_rear_dam.mdl"
					end

					if bgroup == 5 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_rear1_dam.mdl"
					end

					if bgroup == 8 then
						tbl.gib.mdl = "models/diggercars/gtasa/tornado/bump_rear2_dam.mdl"
					end
				end,
				sound = "SA_Collision",
				gib = {
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [6] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [6] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/tornado/door_lf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [5] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [5] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/tornado/door_rf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	-- taillight2 left
	local pos, ang, mins, maxs = self:GetBoneInfo( "l_rl2" )
	self:AddPDS( {
		pos = pos,
		ang = ang,
		mins = mins,
	...
	-- taillight2 right
	local pos, ang, mins, maxs = self:GetBoneInfo( "l_rr2" )
	self:AddPDS( {
		pos = pos,
		ang = ang,
		mins = mins,
