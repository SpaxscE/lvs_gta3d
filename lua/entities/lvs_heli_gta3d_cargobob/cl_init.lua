...
function ENT:OnSpawn()
	self:CreateBonePoseParameter( "door_left", 1, Angle(0,0,0), Angle(-85,0,0), Vector(0,0,0), Vector(0,0,0) )
	self:CreateBonePoseParameter( "door_right", 2, Angle(0,0,0), Angle(85,0,0), Vector(0,0,0), Vector(0,0,0) )
end
