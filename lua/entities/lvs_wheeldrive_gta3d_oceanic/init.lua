...
function ENT:OnSpawn( PObj )
	local DriverSeat = self:AddDriverSeat( Vector(-6,18,0), Angle(0,-90,0) )
	DriverSeat.ExitPos = Vector(-5,80,0)

	local RFSeat = self:AddPassengerSeat( Vector(10,-20,9), Angle(0,-90,20) )
	RFSeat.ExitPos = Vector(-5,-80,0)
	
	local LRSeat = self:AddPassengerSeat( Vector(-27,20,9), Angle(0,-90,20) )
	LRSeat.ExitPos = Vector(-50,80,0)
	
	local RRSeat = self:AddPassengerSeat( Vector(-27,-20,9), Angle(0,-90,20) )
	...
	LRDoorHandler:SetSoundOpen( "gta3d/doors/door_old_open.wav" )
	LRDoorHandler:SetSoundClose( "gta3d/doors/door_old_close.wav" )
	...
	RRDoorHandler:SetSoundOpen( "gta3d/doors/door_old_open.wav" )
	RRDoorHandler:SetSoundClose( "gta3d/doors/door_old_close.wav" )
	...
	local WheelFrontLeft = self:AddWheel( { pos = Vector(72,35.94,6), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelFrontRight = self:AddWheel( { pos = Vector(72,-35.94,6), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )

	local WheelRearLeft = self:AddWheel( { pos = Vector(-71.2,35.94,6), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelRearRight = self:AddWheel( { pos = Vector(-71.2,-35.94,6), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )
