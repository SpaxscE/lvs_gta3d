...
function ENT:OnSpawn( PObj )
	local DriverSeat = self:AddDriverSeat( Vector(-26,13,0), Angle(0,-90,0) )
	DriverSeat.ExitPos = Vector(-5,80,0)

	local RFSeat = self:AddPassengerSeat( Vector(-10,-13,9), Angle(0,-90,20) )
	...
	local WheelFrontLeft = self:AddWheel( { pos = Vector(56.68,34.09,3), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelFrontRight = self:AddWheel( { pos = Vector(56.68,-34.09,3), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )

	local WheelRearLeft = self:AddWheel( { pos = Vector(-56.68,34.09,-1), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelRearRight = self:AddWheel( { pos = Vector(-56.68,-34.09,-1), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )
