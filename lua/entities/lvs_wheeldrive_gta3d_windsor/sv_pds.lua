	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [1] = 2 }, sound = "SA_Collision", maxvelocity = 500 },
			{
				...
				bodygroup = { [1] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/windsor/bonnet_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [2] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [2] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/windsor/boot_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [4] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [4] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/windsor/door_lf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
	...
	self:AddPDS( {
		...
		stages = {
			...
			{ bodygroup = { [3] = 2 }, sound = "SA_Collision" },
			{
				...
				bodygroup = { [3] = 3 },
				gib = {
					mdl = "models/diggercars/gtasa/windsor/door_rf_dam.mdl",
					pos = Vector(0,0,0),
					ang = Angle(0,0,0),
				},
			},
