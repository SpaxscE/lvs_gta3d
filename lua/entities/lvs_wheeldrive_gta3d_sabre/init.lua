...
function ENT:OnSpawn( PObj )
	local DriverSeat = self:AddDriverSeat( Vector(-17,17,-2), Angle(0,-90,0) )
	DriverSeat.ExitPos = Vector(-5,80,0)

	local RFSeat = self:AddPassengerSeat( Vector(0,-18,6), Angle(0,-90,20) )
	...
	local DoorHandler = self:AddDoorHandler( "hood", Vector(20,0,22), Angle(0,0,0), Vector(0,-35,0), Vector(65,35,12), Vector(0,-35,0), Vector(65,35,45) )
	...
	local TrunkHandler = self:AddDoorHandler( "trunk", Vector(-53,0,25), Angle(0,180,0), Vector(0,-35,0), Vector(35,35,8), Vector(0,-35,0), Vector(35,35,30) )
	...
	local WheelModel = "models/diggercars/gtasa/shared/wheel_sabre.mdl"

	local WheelFrontLeft = self:AddWheel( { pos = Vector(61.72,36.97,6), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelFrontRight = self:AddWheel( { pos = Vector(61.72,-36.97,6), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )

	local WheelRearLeft = self:AddWheel( { pos = Vector(-62.16,36.97,6), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )
	local WheelRearRight = self:AddWheel( { pos = Vector(-62.16,-36.97,6), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )
