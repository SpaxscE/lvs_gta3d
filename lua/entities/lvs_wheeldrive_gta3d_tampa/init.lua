...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( self:WorldToLocal( att_seat1.Pos ) + Vector(-13,0,-13), self:WorldToLocalAngles( att_seat1.Ang) + Angle(0,-90,-85) )
	local RFSeat = self:AddPassengerSeat( self:WorldToLocal( att_seat2.Pos ) + Vector(-3,0,-6), self:WorldToLocalAngles( att_seat2.Ang ) + Angle(0,-90,-75) )
	...
	local WheelModel = "models/diggercars/gtasa/shared/wheel_vincent.mdl"
